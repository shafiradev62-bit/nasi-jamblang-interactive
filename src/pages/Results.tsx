  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 pt-16">
      <div className="max-w-2xl mx-auto px-6 py-10 fade-in-up">
        ...
        {/* ── CLOSING SLIDE ── */}
        <div className="mt-8 p-8 bg-gradient-to-br from-primary/5 via-emerald-50 to-teal-50 rounded-2xl border border-primary/15 shadow-sm text-center">
          <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-4">
            <svg className="w-7 h-7 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h2 className="font-display text-xl font-bold text-foreground mb-2 leading-tight">
            {isId
              ? "Terima Kasih Sudah Menjelajahi Cirebon dan Sains!"
              : "Thank You for Exploring Cirebon and Science!"}
          </h2>
          <p className="text-[13px] text-muted-foreground leading-relaxed mb-5">
            {isId
              ? "Kerja bagus! Kamu telah selesai menjelajahi hubungan antara sains dan budaya Cirebon. Semoga kegiatan ini membantumu menikmati belajar, berpikir kritis, dan menghargai kearifan lokal dalam kehidupan sehari-hari."
              : "Great job! You have finished exploring the connection between science and the culture of Cirebon. We hope this activity helps you enjoy learning, think critically, and appreciate local wisdom in everyday life."}
          </p>
          <button
            onClick={() => navigate("/quiz")}
            className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-white text-[13px] font-semibold rounded-xl hover:bg-primary/90 active:scale-95 transition-all shadow-sm"
          >
            {isId ? "Selesai" : "Finish"}
